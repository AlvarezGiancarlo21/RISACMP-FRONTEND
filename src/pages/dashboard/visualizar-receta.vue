      ...
      <v-data-table :headers="headers" :items="recetas" :search="search">
        ...
        <template v-slot:item.actions="{ item }">
          ...
          <v-icon
            class="me-2"
            size="small"
            @click="() => {detalleReceta(item); dialogCambioDisponible = true}"
            :disabled="item.disponible === false"
          >
            mdi-cancel
          </v-icon>
        ...
        >
          <v-card-text>
            ...
            <v-row dense v-if="modoModal === 'Agregar'">
              ...
              <v-col cols="12" md="4" sm="6">
                <v-text-field
                  label="Rendimiento por receta"
                  v-model="nuevaReceta.rendimiento"
                  required
                ></v-text-field>
              </v-col>
              ...
              <v-col cols="12" md="4" sm="6">
                <v-text-field
                  label="Disponible"
                  v-model="nuevaReceta.disponible"
                  required
                ></v-text-field>
              </v-col>
              <v-col cols="12">
                ...
                <div class="container-ingredientes">
                  <div
                    class="elemento-ingrediente"
                    v-for="(ingrediente, index) in nuevaReceta.ingredientes"
                    :key="index"
                  >
                    <v-row>
                      <v-col
            ...
            <v-row dense v-if="modoModal === 'Detalle'">
              <v-col cols="12" md="4" sm="6">
                <v-text-field
                  label="Codigo"
                  v-model="RecetaSeleccionada.codigo"
                  required
                  readonly
                ></v-text-field>
              </v-col>
              ...
              <v-col cols="12" md="4" sm="6">
                <v-text-field
                  label="Rendimiento por receta"
                  v-model="RecetaSeleccionada.rendimiento"
                  required
                  readonly
                ></v-text-field>
              </v-col>
              ...
              <v-col cols="12" md="4" sm="6">
                <v-text-field
                  label="Disponible"
                  v-model="RecetaSeleccionada.disponible"
                  required
                  readonly
                ></v-text-field>
              </v-col>
              ...
              <v-col cols="12" md="12" sm="12">
                ...
                <div class="container-ingredientes">
                  <div
                    ...
                    v-for="(
                      ingrediente, index
                    ) in RecetaSeleccionada.ingredientes"
                    :key="index"
                  >
                    <v-row>
                      <v-col
          ...
          <v-card-actions v-if="modoModal === 'Agregar'">
            ...
            <v-btn
              ...
              text="Agregar"
              variant="tonal"
              @click="dialogAgregarConfirmacion = true"
            ></v-btn>
        ...
        >
          ...
          <template v-slot:actions>
            <v-btn
              class="ms-auto"
              text="Ok"
              @click="dialogAgregarError = false"
            ></v-btn>
          </template>
        </v-card>
      </v-dialog>
        ...
        >
          ...
          <v-card-actions v-if="modoModal === 'Modificar'">
            ...
            <v-btn
              ...
              text="Sí"
              variant="tonal"
              @click="modificarReceta(RecetaSeleccionada)"
            ></v-btn>
            <v-btn
              color="red"
              text="Cancelar"
        ...
        >
          ...
          <v-card-actions v-if="RecetaSeleccionada.disponible === true">
            ...
            <v-btn
              ...
              text="Sí"
              variant="tonal"
              @click="deshabilitarReceta(RecetaSeleccionada)"
            ></v-btn>
            <v-btn
              color="red"
              text="Cancelar"
          ...
          <v-card-actions v-if="RecetaSeleccionada.disponible === false">
            ...
            <v-btn
              ...
              text="Sí"
              variant="tonal"
              @click="habilitarReceta(RecetaSeleccionada)"
            ></v-btn>
            <v-btn
              color="red"
              text="Cancelar"
        ...
        <v-card v-card title="Exportar Usuario es formato EXCEL o PDF">
          ...
          <v-card-actions>
            ...
            <v-btn
              ...
              variant="tonal"
              color="red"
              @click="dialogExportarRecetas = false"
            ></v-btn>
          </v-card-actions>
        </v-card>
      </v-dialog>
