<template>
  <div>
    <v-card class="card" style="margin: 80px auto 0; width: auto;height:120%;">
      <v-card-title> Gestionar Producto Terminado </v-card-title>
      <div class="d-flex justify-center align-center">
      <v-data-table
        :headers="headersTableProductoTerminado"
        :items="produtoTerminado"
        :search="search"
      ...
      >
        <template v-slot:top>
          ...
          text="Registrar Producto Terminado"
          variant="tonal"
              @click="dialogExportarProductoTerminado=true"
            >
              <span>Exportar</span>
            </v-btn>
            <!----------------------------------------->
            ...
            <!--Dialog principal-->
            <v-dialog
              v-model="dialogExportarProductoTerminado"
              max-width="480"
            >
            <v-card v-card title="Exportar Productos Terminados en formato EXCEL o PDF">
          ...
          <v-btn
            text="Close"
            variant="text"
            @click="dialogExportarProductoTerminado = false"
          ></v-btn>
        </v-card-actions>
      </v-card>
    </v-dialog>
    ...
    >
      ...
      <v-card
        ...
        title="Registrar producto terminado en el sistema"
      >
        <v-card-text>
          <v-row dense>
            <v-col
        ...
        <v-card-actions>
          ...
          <v-btn
            text="Close"
            variant="plain"
            @click="dialogRegistrarProductoTerminado = false"
          ></v-btn>
...
const dialogExportarProductoTerminado=ref(false);
//const dialogRegistrarProductoTerminado=ref(false);
...
const search = ref('');
const headersTableProductoTerminado = [
  { title: 'Codigo del Producto', value: 'codigoProducto' },
  { title: 'Nombre del Producto', value: 'nombreProducto' },
  { title: 'Rango de peso', value: 'pesoProducto' },
  { title: 'Lote', value: 'loteProducto' },
  { title: 'Fecha de Produccion', value: 'fechaProduccionProducto' },
  { title: 'Fecha de Vencimiento', value: 'fechaVencimientoProducto', sortable: false },
];
const tableOptions = {
  pagination: {
...
/* 
const cargarProductoTerminado = async () => {
  try {
...
const nuevoProductoTerminado = ref({
  codigo: '',
  nombre:'',
  peso:'',
  lote:'',
