<template>
    ...
    <div class="container-tabla-pedidos">
      ...
      <v-dialog v-model="editarPedidoDialog" max-width="700px" max-height="auto">
        <v-card>
          <v-card-title>Editar Orden de Trabajo</v-card-title>
          <v-card-text>
            <v-row>
              <v-col>
      ...
      <v-dialog v-model="dialogExportarPedidos" max-width="500px">
        <v-card>
          <v-card-title>Exportar Ordenes de Trabajo</v-card-title>
          <v-card-text>
