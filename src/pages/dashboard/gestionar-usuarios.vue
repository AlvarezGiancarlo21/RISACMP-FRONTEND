          ...
          <template v-slot:top>
            <v-toolbar flat>
              ...
              <v-dialog v-model="dialogExportarUsuarios" max-width="480">
                <v-card title="Exportar Usuario en formato EXCEL o PDF">
                  ...
                  <v-card-actions>
                    <v-spacer></v-spacer>
                    <v-btn text="Close" variant="text" @click="dialogExportarUsuarios = false"></v-btn>
                  </v-card-actions>
                </v-card>
              </v-dialog>
      ...
      <v-card title="Editar Usuario">
        <v-card-text>
          <v-row dense>
            ...
            <v-col cols="12" md="4" sm="6">
              <v-text-field v-model="usuarioActual.password" label="Contraseña" type="password" required></v-text-field>
            </v-col>
            <v-col cols="12" sm="6">
              <v-select
